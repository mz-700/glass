...
import org.tbc.glass.instructions.*;
import org.tbc.glass.instructions.Error;
...
public class GlobalScope extends Scope {
	...
	public GlobalScope() {
		...
		addBuiltInSymbol("rel", new Instruction(new Rel(null), new Scope(this)));
		addBuiltInSymbol("endrel", new Instruction(new Endm(), new Scope(this)));
