...
import org.tbc.glass.GlobalScope;
import org.tbc.glass.Line;
import org.tbc.glass.Parser;
import org.tbc.glass.Scope;
import org.tbc.glass.SourceFile;
import org.tbc.glass.TestBase;
...
public class InstructionTest extends TestBase {
	...
	@Test
	public void testMzAsc() {
		assertArrayEquals(b(0x86), parse("mz_asc 86H"));
		assertArrayEquals(b(0x48, 0x92, 0xB8, 0xB8, 0xB7, 0x20, 0x57, 0xB7, 0x9D, 0xB8, 0x9C, 0x21),
			parse("mz_asc \"Hello World!\""));
		assertArrayEquals(b(0x11, 0xA1, 0x9A, 0x9F, 0x22), parse("mz_asc 11H, \"abc\", 22H"));
	}

	@Test
	public void testMzDisp() {
		assertArrayEquals(b(0x86), parse("mz_disp 86H"));
		assertArrayEquals(b(0x01, 0x02, 0x03, 0x04), parse("mz_disp \"ABCD\""));
		assertArrayEquals(b(0x08, 0x85, 0x8C, 0x8C, 0x8F, 0x00, 0x17, 0x8F, 0x92, 0x8C, 0x84, 0x61, 0x00, 0x22, 0x23),
			parse("mz_disp \"Hello World! 23\""));
		assertArrayEquals(b(0x3C, 0xBC, 0x40, 0x49, 0x4F, 0x52, 0x54, 0x55, 0x51, 0x57),
			parse("mz_disp \"_{}?:[]@<>\""));
	}
